...
def create_packing_animation(scenario_number, packing_method, save_gif=False):
    ...
    if save_gif:
        ...
        anim.save(f'{packing_method}_packing_scenario_{scenario_number}.gif', writer=writer)
        print(f"{packing_method.capitalize()} packing animation saved as {packing_method}_packing_scenario_{scenario_number}.gif")
